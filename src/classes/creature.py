...
class Creature(WorldObject):
    ...
    def give_loan(self, borrower: 'Creature', amount: float,
    ...
    def repay_loan(self, lender: 'Creature', amount: float, now: int) -> dict:
    ...
    def collect_debt(self, borrower: 'Creature', now: int) -> dict:
