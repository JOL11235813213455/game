...
#define __PYX_HAVE__fast_tiles
#define __PYX_HAVE_API__fast_tiles
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include <math.h>
...
/*--- Type declarations ---*/
struct __pyx_obj_10fast_tiles_TileGrid;
...
struct __pyx_obj_10fast_tiles_TileGrid {
  PyObject_HEAD
  struct __pyx_vtabstruct_10fast_tiles_TileGrid *__pyx_vtab;
...
struct __pyx_vtabstruct_10fast_tiles_TileGrid {
  int (*_idx)(struct __pyx_obj_10fast_tiles_TileGrid *, int, int);
  int (*_in_bounds)(struct __pyx_obj_10fast_tiles_TileGrid *, int, int);
  int (*_is_walkable)(struct __pyx_obj_10fast_tiles_TileGrid *, int, int);
  int (*_check_exit)(struct __pyx_obj_10fast_tiles_TileGrid *, int, int, int);
};
static struct __pyx_vtabstruct_10fast_tiles_TileGrid *__pyx_vtabptr_10fast_tiles_TileGrid;
static CYTHON_INLINE int __pyx_f_10fast_tiles_8TileGrid__idx(struct __pyx_obj_10fast_tiles_TileGrid *, int, int);
static CYTHON_INLINE int __pyx_f_10fast_tiles_8TileGrid__in_bounds(struct __pyx_obj_10fast_tiles_TileGrid *, int, int);
static CYTHON_INLINE int __pyx_f_10fast_tiles_8TileGrid__is_walkable(struct __pyx_obj_10fast_tiles_TileGrid *, int, int);
static CYTHON_INLINE int __pyx_f_10fast_tiles_8TileGrid__check_exit(struct __pyx_obj_10fast_tiles_TileGrid *, int, int, int);
...
static CYTHON_INLINE int __pyx_f_10fast_tiles_8TileGrid__idx(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self, int __pyx_v_x, int __pyx_v_y); /* proto*/
static CYTHON_INLINE int __pyx_f_10fast_tiles_8TileGrid__in_bounds(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self, int __pyx_v_x, int __pyx_v_y); /* proto*/
static CYTHON_INLINE int __pyx_f_10fast_tiles_8TileGrid__is_walkable(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self, int __pyx_v_x, int __pyx_v_y); /* proto*/
static CYTHON_INLINE int __pyx_f_10fast_tiles_8TileGrid__check_exit(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self, int __pyx_v_x, int __pyx_v_y, int __pyx_v_bit); /* proto*/
...
/* Module declarations from "fast_tiles" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "fast_tiles"
extern int __pyx_module_is_main_fast_tiles;
int __pyx_module_is_main_fast_tiles = 0;

/* Implementation of "fast_tiles" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_Flat_C_arrays_for_tile_walkabil[] = "\nFlat C arrays for tile walkability and bounds \342\200\224 fast raycaster + spatial wall queries.\n\nSynced from the Python tile dict once per tick (or on map change).\nThe raycaster and observation spatial_walls section read from these\narrays instead of doing Python dict lookups per cell.\n";
/* #### Code section: decls ### */
static int __pyx_pf_10fast_tiles_8TileGrid___cinit__(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self); /* proto */
static void __pyx_pf_10fast_tiles_8TileGrid_2__dealloc__(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_10fast_tiles_8TileGrid_4sync(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self, PyObject *__pyx_v_game_map); /* proto */
...
typedef struct {
  ...
  PyObject *__pyx_type_10fast_tiles_TileGrid;
  PyTypeObject *__pyx_ptype_10fast_tiles_TileGrid;
...
/* Python wrapper */
static int __pyx_pw_10fast_tiles_8TileGrid_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_10fast_tiles_8TileGrid_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_10fast_tiles_8TileGrid___cinit__(((struct __pyx_obj_10fast_tiles_TileGrid *)__pyx_v_self));
...
static int __pyx_pf_10fast_tiles_8TileGrid___cinit__(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self) {
  int __pyx_r;
...
/* Python wrapper */
static void __pyx_pw_10fast_tiles_8TileGrid_3__dealloc__(PyObject *__pyx_v_self); /*proto*/
static void __pyx_pw_10fast_tiles_8TileGrid_3__dealloc__(PyObject *__pyx_v_self) {
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__ (wrapper)", 0);
  __pyx_kwvalues = __Pyx_KwValues_VARARGS(__pyx_args, __pyx_nargs);
  __pyx_pf_10fast_tiles_8TileGrid_2__dealloc__(((struct __pyx_obj_10fast_tiles_TileGrid *)__pyx_v_self));

  /* function exit code */
  __Pyx_RefNannyFinishContext();
}

static void __pyx_pf_10fast_tiles_8TileGrid_2__dealloc__(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self) {
  int __pyx_t_1;
...
*/
  __pyx_t_1 = (__pyx_v_self->walkable != NULL);
  if (__pyx_t_1) {
    free(__pyx_v_self->walkable);
  }
...
*/
  __pyx_t_1 = (__pyx_v_self->bounds != NULL);
  if (__pyx_t_1) {
    free(__pyx_v_self->bounds);
  }
 ...
 * 
*/
  __pyx_t_1 = (__pyx_v_self->liquid != NULL);
  if (__pyx_t_1) {
    free(__pyx_v_self->liquid);
  }
...
*/
  __pyx_t_1 = (__pyx_v_self->covered != NULL);
  if (__pyx_t_1) {
    free(__pyx_v_self->covered);
  }
...
/* Python wrapper */
static PyObject *__pyx_pw_10fast_tiles_8TileGrid_5sync(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_10fast_tiles_8TileGrid_4sync, "Sync from Python tile dict. Call on map load or tile changes.");
static PyMethodDef __pyx_mdef_10fast_tiles_8TileGrid_5sync = {"sync", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_10fast_tiles_8TileGrid_5sync, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_10fast_tiles_8TileGrid_4sync};
static PyObject *__pyx_pw_10fast_tiles_8TileGrid_5sync(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_game_map,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "sync", 0) < (0)) __PYX_ERR(0, 51, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("sync", 1, 1, 1, i); __PYX_ERR(0, 51, __pyx_L3_error) }
      }
    ...
    __pyx_v_game_map = values[0];
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("sync", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 51, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("fast_tiles.TileGrid.sync", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10fast_tiles_8TileGrid_4sync(((struct __pyx_obj_10fast_tiles_TileGrid *)__pyx_v_self), __pyx_v_game_map);
...
static PyObject *__pyx_pf_10fast_tiles_8TileGrid_4sync(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self, PyObject *__pyx_v_game_map) {
  int __pyx_v_w;
  int __pyx_v_h;
  int __pyx_v_n;
  int __pyx_v_i;
...
*/
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_game_map, __pyx_mstate_global->__pyx_n_u_x_max); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_game_map, __pyx_mstate_global->__pyx_n_u_x_min); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyNumber_Subtract(__pyx_t_1, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyLong_AddObjC(__pyx_t_3, __pyx_mstate_global->__pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_4 = __Pyx_PyLong_As_int(__pyx_t_2); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_w = __pyx_t_4;
...
*/
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_game_map, __pyx_mstate_global->__pyx_n_u_y_max); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_game_map, __pyx_mstate_global->__pyx_n_u_y_min); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = PyNumber_Subtract(__pyx_t_2, __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyLong_AddObjC(__pyx_t_1, __pyx_mstate_global->__pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_4 = __Pyx_PyLong_As_int(__pyx_t_3); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_h = __pyx_t_4;
 ...
 *         self.width = w
*/
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_game_map, __pyx_mstate_global->__pyx_n_u_x_min); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyLong_As_int(__pyx_t_3); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_self->x_min = __pyx_t_4;
 ...
 *         self.height = h
*/
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_game_map, __pyx_mstate_global->__pyx_n_u_y_min); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyLong_As_int(__pyx_t_3); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_self->y_min = __pyx_t_4;
 ...
 *         if self.liquid != NULL:   free(self.liquid)
*/
  __pyx_t_5 = (__pyx_v_self->walkable != NULL);
  if (__pyx_t_5) {
    free(__pyx_v_self->walkable);
  }
 ...
 *         if self.covered != NULL:  free(self.covered)
*/
  __pyx_t_5 = (__pyx_v_self->bounds != NULL);
  if (__pyx_t_5) {
    free(__pyx_v_self->bounds);
  }
...
*/
  __pyx_t_5 = (__pyx_v_self->liquid != NULL);
  if (__pyx_t_5) {
    free(__pyx_v_self->liquid);
  }
...
*/
  __pyx_t_5 = (__pyx_v_self->covered != NULL);
  if (__pyx_t_5) {
    free(__pyx_v_self->covered);
  }
...
*/
  __pyx_v_self->walkable = ((unsigned char *)malloc(__pyx_v_n));
...
*/
  __pyx_v_self->bounds = ((unsigned char *)malloc(__pyx_v_n));
 ...
 * 
*/
  __pyx_v_self->liquid = ((unsigned char *)malloc(__pyx_v_n));
...
*/
  __pyx_v_self->covered = ((unsigned char *)malloc(__pyx_v_n));
 ...
 *             self.liquid[i] = 0
*/
    (__pyx_v_self->walkable[__pyx_v_i]) = 0;
 ...
 *             self.covered[i] = 0
*/
    (__pyx_v_self->bounds[__pyx_v_i]) = 0xFF;
 ...
 * 
*/
    (__pyx_v_self->liquid[__pyx_v_i]) = 0;
...
*/
    (__pyx_v_self->covered[__pyx_v_i]) = 0;
  }
...
*/
  __pyx_t_8 = 0;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_game_map, __pyx_mstate_global->__pyx_n_u_tiles); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (unlikely(__pyx_t_1 == Py_None)) {
    PyErr_Format(PyExc_AttributeError, "'NoneType' object has no attribute '%.30s'", "items");
    __PYX_ERR(0, 81, __pyx_L1_error)
  }
  __pyx_t_2 = __Pyx_dict_iterator(__pyx_t_1, 0, __pyx_mstate_global->__pyx_n_u_items, (&__pyx_t_9), (&__pyx_t_4)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __pyx_t_2 = 0;
  while (1) {
    __pyx_t_6 = __Pyx_dict_iter_next(__pyx_t_3, __pyx_t_9, &__pyx_t_8, &__pyx_t_2, &__pyx_t_1, NULL, __pyx_t_4);
...
*/
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_key, __pyx_mstate_global->__pyx_n_u_x); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 82, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __Pyx_PyLong_From_int(__pyx_v_self->x_min); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 82, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_10 = PyNumber_Subtract(__pyx_t_1, __pyx_t_2); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 82, __pyx_L1_error)
 ...
 *                 continue
*/
    __pyx_t_10 = __Pyx_PyObject_GetAttrStr(__pyx_v_key, __pyx_mstate_global->__pyx_n_u_y); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 83, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __pyx_t_2 = __Pyx_PyLong_From_int(__pyx_v_self->y_min); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 83, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = PyNumber_Subtract(__pyx_t_10, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 83, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
 ...
 *             idx = ty * w + tx
*/
    __pyx_t_1 = PyObject_RichCompare(__pyx_v_tx, __pyx_mstate_global->__pyx_int_0, Py_LT); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 84, __pyx_L1_error)
    ...
    __pyx_t_1 = __Pyx_PyLong_From_int(__pyx_v_w); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = PyObject_RichCompare(__pyx_v_tx, __pyx_t_1, Py_GE); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_11 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely((__pyx_t_11 < 0))) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    if (!__pyx_t_11) {
    } else {
      __pyx_t_5 = __pyx_t_11;
    ...
    __pyx_t_2 = PyObject_RichCompare(__pyx_v_ty, __pyx_mstate_global->__pyx_int_0, Py_LT); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 84, __pyx_L1_error)
    __pyx_t_11 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely((__pyx_t_11 < 0))) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    if (!__pyx_t_11) {
    } else {
    ...
    __pyx_t_2 = __Pyx_PyLong_From_int(__pyx_v_h); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = PyObject_RichCompare(__pyx_v_ty, __pyx_t_2, Py_GE); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_11 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely((__pyx_t_11 < 0))) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_5 = __pyx_t_11;
...
*/
    __pyx_t_1 = __Pyx_PyLong_From_int(__pyx_v_w); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 86, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = PyNumber_Multiply(__pyx_v_ty, __pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 86, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = PyNumber_Add(__pyx_t_2, __pyx_v_tx); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 86, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_tile, __pyx_mstate_global->__pyx_n_u_walkable); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 87, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    ...
    __pyx_t_13 = __Pyx_PyIndex_AsSsize_t(__pyx_v_idx); if (unlikely((__pyx_t_13 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 87, __pyx_L1_error)
    (__pyx_v_self->walkable[__pyx_t_13]) = __pyx_t_12;
 ...
 * 
*/
    __pyx_t_1 = __Pyx_GetAttr3(__pyx_v_tile, __pyx_mstate_global->__pyx_n_u_liquid, Py_False); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 88, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    ...
    __pyx_t_13 = __Pyx_PyIndex_AsSsize_t(__pyx_v_idx); if (unlikely((__pyx_t_13 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 88, __pyx_L1_error)
    (__pyx_v_self->liquid[__pyx_t_13]) = __pyx_t_12;
 ...
 *             # Pack bounds
*/
    __pyx_t_1 = __Pyx_GetAttr3(__pyx_v_tile, __pyx_mstate_global->__pyx_n_u_covered, Py_False); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 89, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    ...
    __pyx_t_13 = __Pyx_PyIndex_AsSsize_t(__pyx_v_idx); if (unlikely((__pyx_t_13 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 89, __pyx_L1_error)
    (__pyx_v_self->covered[__pyx_t_13]) = __pyx_t_12;
 ...
 *                 packed = 0
*/
    __pyx_t_1 = __Pyx_GetAttr3(__pyx_v_tile, __pyx_mstate_global->__pyx_n_u_bounds, Py_None); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 92, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
...
*/
      __pyx_t_1 = __Pyx_GetAttr3(__pyx_v_b, __pyx_mstate_global->__pyx_n_u_n, Py_True); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 95, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_5 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely((__pyx_t_5 < 0))) __PYX_ERR(0, 95, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      if (__pyx_t_5) {
        __pyx_v_packed = (__pyx_v_packed | 0x1);
      }
...
*/
      __pyx_t_1 = __Pyx_GetAttr3(__pyx_v_b, __pyx_mstate_global->__pyx_n_u_s, Py_True); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 96, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_5 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely((__pyx_t_5 < 0))) __PYX_ERR(0, 96, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      if (__pyx_t_5) {
        __pyx_v_packed = (__pyx_v_packed | 0x2);
      }
...
*/
      __pyx_t_1 = __Pyx_GetAttr3(__pyx_v_b, __pyx_mstate_global->__pyx_n_u_e, Py_True); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 97, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_5 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely((__pyx_t_5 < 0))) __PYX_ERR(0, 97, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      if (__pyx_t_5) {
        __pyx_v_packed = (__pyx_v_packed | 0x4);
      }
...
*/
      __pyx_t_1 = __Pyx_GetAttr3(__pyx_v_b, __pyx_mstate_global->__pyx_n_u_w, Py_True); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 98, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_5 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely((__pyx_t_5 < 0))) __PYX_ERR(0, 98, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      if (__pyx_t_5) {
        __pyx_v_packed = (__pyx_v_packed | 0x8);
      }
...
*/
      __pyx_t_1 = __Pyx_GetAttr3(__pyx_v_b, __pyx_mstate_global->__pyx_n_u_ne, Py_True); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 99, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_5 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely((__pyx_t_5 < 0))) __PYX_ERR(0, 99, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      if (__pyx_t_5) {
        __pyx_v_packed = (__pyx_v_packed | 0x10);
      }
...
*/
      __pyx_t_1 = __Pyx_GetAttr3(__pyx_v_b, __pyx_mstate_global->__pyx_n_u_nw, Py_True); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 100, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_5 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely((__pyx_t_5 < 0))) __PYX_ERR(0, 100, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      if (__pyx_t_5) {
        __pyx_v_packed = (__pyx_v_packed | 0x20);
      }
...
*/
      __pyx_t_1 = __Pyx_GetAttr3(__pyx_v_b, __pyx_mstate_global->__pyx_n_u_se, Py_True); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 101, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_5 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely((__pyx_t_5 < 0))) __PYX_ERR(0, 101, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      if (__pyx_t_5) {
        __pyx_v_packed = (__pyx_v_packed | 0x40);
      }
 ...
 * 
*/
      __pyx_t_1 = __Pyx_GetAttr3(__pyx_v_b, __pyx_mstate_global->__pyx_n_u_sw, Py_True); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 102, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_5 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely((__pyx_t_5 < 0))) __PYX_ERR(0, 102, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      if (__pyx_t_5) {
        __pyx_v_packed = (__pyx_v_packed | 0x80);
      }
...
*/
      __pyx_t_13 = __Pyx_PyIndex_AsSsize_t(__pyx_v_idx); if (unlikely((__pyx_t_13 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 103, __pyx_L1_error)
      (__pyx_v_self->bounds[__pyx_t_13]) = __pyx_v_packed;
...
static CYTHON_INLINE int __pyx_f_10fast_tiles_8TileGrid__idx(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self, int __pyx_v_x, int __pyx_v_y) {
  int __pyx_r;
...
*/
  __pyx_r = (((__pyx_v_y - __pyx_v_self->y_min) * __pyx_v_self->width) + (__pyx_v_x - __pyx_v_self->x_min));
  goto __pyx_L0;
...
static CYTHON_INLINE int __pyx_f_10fast_tiles_8TileGrid__in_bounds(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self, int __pyx_v_x, int __pyx_v_y) {
  int __pyx_v_lx;
  int __pyx_v_ly;
  int __pyx_r;
  int __pyx_t_1;
...
*/
  __pyx_v_lx = (__pyx_v_x - __pyx_v_self->x_min);
 ...
 * 
*/
  __pyx_v_ly = (__pyx_v_y - __pyx_v_self->y_min);
...
*/
  __pyx_t_2 = (0 <= __pyx_v_lx);
  if (__pyx_t_2) {
    __pyx_t_2 = (__pyx_v_lx < __pyx_v_self->width);
  }
  if (__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
  ...
  __pyx_t_2 = (0 <= __pyx_v_ly);
  if (__pyx_t_2) {
    __pyx_t_2 = (__pyx_v_ly < __pyx_v_self->height);
  }
  __pyx_t_1 = __pyx_t_2;
...
static CYTHON_INLINE int __pyx_f_10fast_tiles_8TileGrid__is_walkable(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self, int __pyx_v_x, int __pyx_v_y) {
  int __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
...
*/
  __pyx_t_1 = __pyx_f_10fast_tiles_8TileGrid__in_bounds(__pyx_v_self, __pyx_v_x, __pyx_v_y); if (unlikely(__Pyx_ErrOccurredWithGIL())) __PYX_ERR(0, 114, __pyx_L1_error)
  __pyx_t_2 = (!__pyx_t_1);
  if (__pyx_t_2) {
...
*/
  __pyx_t_3 = __pyx_f_10fast_tiles_8TileGrid__idx(__pyx_v_self, __pyx_v_x, __pyx_v_y); if (unlikely(__Pyx_ErrOccurredWithGIL())) __PYX_ERR(0, 116, __pyx_L1_error)
  __pyx_r = ((__pyx_v_self->walkable[__pyx_t_3]) != 0);
  goto __pyx_L0;
...
*/
  ...
  __Pyx_AddTraceback("fast_tiles.TileGrid._is_walkable", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
...
static CYTHON_INLINE int __pyx_f_10fast_tiles_8TileGrid__check_exit(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self, int __pyx_v_x, int __pyx_v_y, int __pyx_v_bit) {
  int __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
...
*/
  __pyx_t_1 = __pyx_f_10fast_tiles_8TileGrid__in_bounds(__pyx_v_self, __pyx_v_x, __pyx_v_y); if (unlikely(__Pyx_ErrOccurredWithGIL())) __PYX_ERR(0, 120, __pyx_L1_error)
  __pyx_t_2 = (!__pyx_t_1);
  if (__pyx_t_2) {
...
*/
  __pyx_t_3 = __pyx_f_10fast_tiles_8TileGrid__idx(__pyx_v_self, __pyx_v_x, __pyx_v_y); if (unlikely(__Pyx_ErrOccurredWithGIL())) __PYX_ERR(0, 122, __pyx_L1_error)
  __pyx_r = (((__pyx_v_self->bounds[__pyx_t_3]) >> __pyx_v_bit) & 1);
  goto __pyx_L0;
...
*/
  ...
  __pyx_L1_error:;
  __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
  __Pyx_AddTraceback("fast_tiles.TileGrid._check_exit", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __Pyx_PyGILState_Release(__pyx_gilstate_save);
  __pyx_L0:;
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_10fast_tiles_8TileGrid_7is_walkable(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static PyMethodDef __pyx_mdef_10fast_tiles_8TileGrid_7is_walkable = {"is_walkable", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_10fast_tiles_8TileGrid_7is_walkable, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_10fast_tiles_8TileGrid_7is_walkable(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("is_walkable (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "is_walkable", 0) < (0)) __PYX_ERR(0, 124, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("is_walkable", 1, 2, 2, i); __PYX_ERR(0, 124, __pyx_L3_error) }
      }
    ...
    __pyx_v_x = __Pyx_PyLong_As_int(values[0]); if (unlikely((__pyx_v_x == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 124, __pyx_L3_error)
    __pyx_v_y = __Pyx_PyLong_As_int(values[1]); if (unlikely((__pyx_v_y == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 124, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("is_walkable", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 124, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("fast_tiles.TileGrid.is_walkable", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10fast_tiles_8TileGrid_6is_walkable(((struct __pyx_obj_10fast_tiles_TileGrid *)__pyx_v_self), __pyx_v_x, __pyx_v_y);
...
static PyObject *__pyx_pf_10fast_tiles_8TileGrid_6is_walkable(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self, int __pyx_v_x, int __pyx_v_y) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("is_walkable", 0);
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_10fast_tiles_8TileGrid__is_walkable(__pyx_v_self, __pyx_v_x, __pyx_v_y); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 125, __pyx_L1_error)
...
/* Python wrapper */
static PyObject *__pyx_pw_10fast_tiles_8TileGrid_9is_passable(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyDoc_STRVAR(__pyx_doc_10fast_tiles_8TileGrid_8is_passable, "Check if movement from (from) to (to) is possible (walkable + bounds).");
static PyMethodDef __pyx_mdef_10fast_tiles_8TileGrid_9is_passable = {"is_passable", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_10fast_tiles_8TileGrid_9is_passable, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_10fast_tiles_8TileGrid_8is_passable};
static PyObject *__pyx_pw_10fast_tiles_8TileGrid_9is_passable(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("is_passable (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_from_x,&__pyx_mstate_global->__pyx_n_u_from_y,&__pyx_mstate_global->__pyx_n_u_to_x,&__pyx_mstate_global->__pyx_n_u_to_y,0};
    const Py_ssize_t __pyx_kwds_len = (__pyx_kwds) ? __Pyx_NumKwargs_FASTCALL(__pyx_kwds) : 0;
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "is_passable", 0) < (0)) __PYX_ERR(0, 127, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 4; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("is_passable", 1, 4, 4, i); __PYX_ERR(0, 127, __pyx_L3_error) }
      }
    ...
    __pyx_v_from_x = __Pyx_PyLong_As_int(values[0]); if (unlikely((__pyx_v_from_x == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 127, __pyx_L3_error)
    __pyx_v_from_y = __Pyx_PyLong_As_int(values[1]); if (unlikely((__pyx_v_from_y == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 127, __pyx_L3_error)
    __pyx_v_to_x = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_to_x == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 127, __pyx_L3_error)
    __pyx_v_to_y = __Pyx_PyLong_As_int(values[3]); if (unlikely((__pyx_v_to_y == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 127, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("is_passable", 1, 4, 4, __pyx_nargs); __PYX_ERR(0, 127, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("fast_tiles.TileGrid.is_passable", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10fast_tiles_8TileGrid_8is_passable(((struct __pyx_obj_10fast_tiles_TileGrid *)__pyx_v_self), __pyx_v_from_x, __pyx_v_from_y, __pyx_v_to_x, __pyx_v_to_y);
...
static PyObject *__pyx_pf_10fast_tiles_8TileGrid_8is_passable(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self, int __pyx_v_from_x, int __pyx_v_from_y, int __pyx_v_to_x, int __pyx_v_to_y) {
  int __pyx_v_dx;
  int __pyx_v_dy;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("is_passable", 0);
...
*/
  __pyx_t_1 = __pyx_f_10fast_tiles_8TileGrid__is_walkable(__pyx_v_self, __pyx_v_to_x, __pyx_v_to_y); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 129, __pyx_L1_error)
  __pyx_t_2 = (!__pyx_t_1);
  if (__pyx_t_2) {
...
*/
  __pyx_v_dx = (__pyx_v_to_x - __pyx_v_from_x);
...
*/
  __pyx_v_dy = (__pyx_v_to_y - __pyx_v_from_y);
...
*/
  __pyx_t_2 = __pyx_f_10fast_tiles_8TileGrid__check_exit(__pyx_v_self, __pyx_v_from_x, __pyx_v_from_y, __pyx_v_exit_bit); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 154, __pyx_L1_error)
  __pyx_t_1 = (!__pyx_t_2);
  if (__pyx_t_1) {
 ...
 *         return True
*/
  __pyx_t_1 = __pyx_f_10fast_tiles_8TileGrid__check_exit(__pyx_v_self, __pyx_v_to_x, __pyx_v_to_y, __pyx_v_entry_bit); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 156, __pyx_L1_error)
  __pyx_t_2 = (!__pyx_t_1);
  if (__pyx_t_2) {
...
/* Python wrapper */
static PyObject *__pyx_pw_10fast_tiles_8TileGrid_11spatial_walls(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyDoc_STRVAR(__pyx_doc_10fast_tiles_8TileGrid_10spatial_walls, "Compute the 25-float spatial_walls section for observation.\n\n        8 ray-cast distances + 8 adjacent passability + 3 ring walkability\n        + 3 chokepoint + 2 exit direction = 25 floats.\n\n        Returns a list of 25 floats matching the observation format.\n        ");
static PyMethodDef __pyx_mdef_10fast_tiles_8TileGrid_11spatial_walls = {"spatial_walls", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_10fast_tiles_8TileGrid_11spatial_walls, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_10fast_tiles_8TileGrid_10spatial_walls};
static PyObject *__pyx_pw_10fast_tiles_8TileGrid_11spatial_walls(PyObject *__pyx_v_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("spatial_walls (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_cx,&__pyx_mstate_global->__pyx_n_u_cy,&__pyx_mstate_global->__pyx_n_u_sight,0};
    const Py_ssize_t __pyx_kwds_len = (__pyx_kwds) ? __Pyx_NumKwargs_FASTCALL(__pyx_kwds) : 0;
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "spatial_walls", 0) < (0)) __PYX_ERR(0, 160, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("spatial_walls", 1, 3, 3, i); __PYX_ERR(0, 160, __pyx_L3_error) }
      }
    ...
    __pyx_v_cx = __Pyx_PyLong_As_int(values[0]); if (unlikely((__pyx_v_cx == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 160, __pyx_L3_error)
    __pyx_v_cy = __Pyx_PyLong_As_int(values[1]); if (unlikely((__pyx_v_cy == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 160, __pyx_L3_error)
    __pyx_v_sight = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_sight == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 160, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("spatial_walls", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 160, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("fast_tiles.TileGrid.spatial_walls", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10fast_tiles_8TileGrid_10spatial_walls(((struct __pyx_obj_10fast_tiles_TileGrid *)__pyx_v_self), __pyx_v_cx, __pyx_v_cy, __pyx_v_sight);
...
static PyObject *__pyx_pf_10fast_tiles_8TileGrid_10spatial_walls(struct __pyx_obj_10fast_tiles_TileGrid *__pyx_v_self, int __pyx_v_cx, int __pyx_v_cy, int __pyx_v_sight) {
  float __pyx_v_sight_f;
  int __pyx_v_dirs[8][2];
  ...
  int __pyx_v_ppy;
  int __pyx_v_i;
  int __pyx_v_passable;
  int __pyx_v_ring;
  int __pyx_v_ring_tiles;
  int __pyx_v_ring_walk;
  int __pyx_v_ddx;
  int __pyx_v_ddy;
  int __pyx_v_adj_walk;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  long __pyx_t_2;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("spatial_walls", 0);
...
*/
  ...
  __pyx_v_sight_f = ((float)__pyx_t_3);
 ...
 *             d = 0
*/
    __pyx_v_dx = ((__pyx_v_dirs[__pyx_v_i])[0]);
...
*/
    __pyx_v_dy = ((__pyx_v_dirs[__pyx_v_i])[1]);
...
*/
      __pyx_v_px = (__pyx_v_cx + (__pyx_v_dx * __pyx_v_step));
 ...
 *                     break
*/
      __pyx_v_py = (__pyx_v_cy + (__pyx_v_dy * __pyx_v_step));
 ...
 *                 # Check bounds
*/
      __pyx_t_4 = __pyx_f_10fast_tiles_8TileGrid__is_walkable(__pyx_v_self, __pyx_v_px, __pyx_v_py); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 191, __pyx_L1_error)
      __pyx_t_7 = (!__pyx_t_4);
      if (__pyx_t_7) {
...
*/
      __pyx_v_ppx = (__pyx_v_cx + (__pyx_v_dx * (__pyx_v_step - 1)));
 ...
 *                     break
*/
      __pyx_v_ppy = (__pyx_v_cy + (__pyx_v_dy * (__pyx_v_step - 1)));
...
*/
      ...
      __pyx_t_9 = __Pyx_PyLong_From_int(__pyx_v_ppx); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 196, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      __pyx_t_10 = __Pyx_PyLong_From_int(__pyx_v_ppy); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 196, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __pyx_t_11 = __Pyx_PyLong_From_int(__pyx_v_px); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 196, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_12 = __Pyx_PyLong_From_int(__pyx_v_py); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 196, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_12);
      __pyx_t_13 = 0;
      {
        PyObject *__pyx_callargs[5] = {__pyx_t_8, __pyx_t_9, __pyx_t_10, __pyx_t_11, __pyx_t_12};
        __pyx_t_5 = __Pyx_PyObject_FastCallMethod((PyObject*)__pyx_mstate_global->__pyx_n_u_is_passable, __pyx_callargs+__pyx_t_13, (5-__pyx_t_13) | (1*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
...
*/
    __pyx_t_5 = PyFloat_FromDouble((((float)__pyx_v_d) / __pyx_v_sight_f)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 199, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_14 = __Pyx_PyList_Append(__pyx_v_result, __pyx_t_5); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 199, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  }
...
*/
    ...
    __pyx_t_11 = __Pyx_PyLong_From_int(__pyx_v_cx); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 205, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    __pyx_t_10 = __Pyx_PyLong_From_int(__pyx_v_cy); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 205, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __pyx_t_9 = __Pyx_PyLong_From_int((__pyx_v_cx + __pyx_v_dx)); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 205, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_8 = __Pyx_PyLong_From_int((__pyx_v_cy + __pyx_v_dy)); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 205, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_13 = 0;
    {
      PyObject *__pyx_callargs[5] = {__pyx_t_12, __pyx_t_11, __pyx_t_10, __pyx_t_9, __pyx_t_8};
      __pyx_t_5 = __Pyx_PyObject_FastCallMethod((PyObject*)__pyx_mstate_global->__pyx_n_u_is_passable, __pyx_callargs+__pyx_t_13, (5-__pyx_t_13) | (1*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
    ...
    __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 205, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_v_passable = __pyx_t_4;
...
*/
    if (__pyx_v_passable) {
      ...
      __pyx_t_5 = __pyx_mstate_global->__pyx_float_1_0;
    } else {
      __Pyx_INCREF(__pyx_mstate_global->__pyx_float_0_0);
      __pyx_t_5 = __pyx_mstate_global->__pyx_float_0_0;
    }
    __pyx_t_14 = __Pyx_PyList_Append(__pyx_v_result, __pyx_t_5); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 206, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  }
...
*/
    __pyx_t_3 = (__pyx_v_ring + 1);
    __pyx_t_2 = __pyx_t_3;
    for (__pyx_t_6 = (-__pyx_v_ring); __pyx_t_6 < __pyx_t_2; __pyx_t_6+=1) {
      __pyx_v_ddx = __pyx_t_6;
 ...
 *                         ring_tiles += 1
*/
      __pyx_t_15 = (__pyx_v_ring + 1);
      __pyx_t_16 = __pyx_t_15;
      for (__pyx_t_17 = (-__pyx_v_ring); __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
        __pyx_v_ddy = __pyx_t_17;
...
*/
        __pyx_t_18 = abs(__pyx_v_ddx); if (unlikely(__pyx_t_18 == ((int)-1))) __PYX_ERR(0, 215, __pyx_L1_error)
        __pyx_t_7 = (__pyx_t_18 == __pyx_v_ring);
        if (!__pyx_t_7) {
        } else {
          __pyx_t_4 = __pyx_t_7;
          goto __pyx_L18_bool_binop_done;
        }
        __pyx_t_18 = abs(__pyx_v_ddy); if (unlikely(__pyx_t_18 == ((int)-1))) __PYX_ERR(0, 215, __pyx_L1_error)
        __pyx_t_7 = (__pyx_t_18 == __pyx_v_ring);
        __pyx_t_4 = __pyx_t_7;
 ...
 *                             ring_walk += 1
*/
          __pyx_v_ring_tiles = (__pyx_v_ring_tiles + 1);
...
*/
          __pyx_t_4 = __pyx_f_10fast_tiles_8TileGrid__is_walkable(__pyx_v_self, (__pyx_v_cx + __pyx_v_ddx), (__pyx_v_cy + __pyx_v_ddy)); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 217, __pyx_L1_error)
          if (__pyx_t_4) {
 ...
 * 
*/
            __pyx_v_ring_walk = (__pyx_v_ring_walk + 1);
...
*/
    ...
    __pyx_t_5 = PyFloat_FromDouble((((float)__pyx_v_ring_walk) / ((float)__pyx_t_2))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 219, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
...
*/
    __pyx_t_4 = __pyx_f_10fast_tiles_8TileGrid__is_walkable(__pyx_v_self, (__pyx_v_cx + ((__pyx_v_dirs[__pyx_v_i])[0])), (__pyx_v_cy + ((__pyx_v_dirs[__pyx_v_i])[1]))); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 224, __pyx_L1_error)
    if (__pyx_t_4) {
...
*/
      __pyx_v_adj_walk = (__pyx_v_adj_walk + 1);
...
*/
  ...
  __pyx_t_14 = __Pyx_PyList_Append(__pyx_v_result, __pyx_t_5); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 226, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
...
*/
  ...
  __pyx_t_14 = __Pyx_PyList_Append(__pyx_v_result, __pyx_t_5); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 227, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
...
*/
  ...
  __pyx_t_14 = __Pyx_PyList_Append(__pyx_v_result, __pyx_t_5); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 228, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 * 
*/
  __pyx_t_14 = __Pyx_PyList_Append(__pyx_v_result, __pyx_mstate_global->__pyx_float_0_0); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 231, __pyx_L1_error)
 ...
 *         return result
*/
  __pyx_t_14 = __Pyx_PyList_Append(__pyx_v_result, __pyx_mstate_global->__pyx_float_0_0); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 232, __pyx_L1_error)
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("fast_tiles.TileGrid.__reduce_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_AddTraceback("fast_tiles.TileGrid.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
...
static struct __pyx_vtabstruct_10fast_tiles_TileGrid __pyx_vtable_10fast_tiles_TileGrid;

static PyObject *__pyx_tp_new_10fast_tiles_TileGrid(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  struct __pyx_obj_10fast_tiles_TileGrid *p;
  PyObject *o;
  o = __Pyx_AllocateExtensionType(t, 0);
  if (unlikely(!o)) return 0;
  p = ((struct __pyx_obj_10fast_tiles_TileGrid *)o);
  p->__pyx_vtab = __pyx_vtabptr_10fast_tiles_TileGrid;
  if (unlikely(__pyx_pw_10fast_tiles_8TileGrid_1__cinit__(o, __pyx_mstate_global->__pyx_empty_tuple, NULL) < 0)) goto bad;
  return o;
  bad:
  Py_DECREF(o); o = 0;
  return NULL;
...
static void __pyx_tp_dealloc_10fast_tiles_TileGrid(PyObject *o) {
  #if CYTHON_USE_TP_FINALIZE
  if (unlikely(__Pyx_PyObject_GetSlot(o, tp_finalize, destructor)) && (!PyType_IS_GC(Py_TYPE(o)) || !__Pyx_PyObject_GC_IsFinalized(o))) {
    if (__Pyx_PyObject_GetSlot(o, tp_dealloc, destructor) == __pyx_tp_dealloc_10fast_tiles_TileGrid) {
  ...
  #endif
  {
    ...
    __pyx_pw_10fast_tiles_8TileGrid_3__dealloc__(o);
    __Pyx_SET_REFCNT(o, Py_REFCNT(o) - 1);
...
static PyMethodDef __pyx_methods_10fast_tiles_TileGrid[] = {
  {"sync", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_10fast_tiles_8TileGrid_5sync, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_10fast_tiles_8TileGrid_4sync},
...
#if CYTHON_USE_TYPE_SPECS
static PyType_Slot __pyx_type_10fast_tiles_TileGrid_slots[] = {
  {Py_tp_dealloc, (void *)__pyx_tp_dealloc_10fast_tiles_TileGrid},
  {Py_tp_doc, (void *)PyDoc_STR("Flat C arrays mirroring the Python tile dict for fast spatial queries.")},
  {Py_tp_methods, (void *)__pyx_methods_10fast_tiles_TileGrid},
  {Py_tp_new, (void *)__pyx_tp_new_10fast_tiles_TileGrid},
  {0, 0},
};
static PyType_Spec __pyx_type_10fast_tiles_TileGrid_spec = {
  "fast_tiles.TileGrid",
  sizeof(struct __pyx_obj_10fast_tiles_TileGrid),
  0,
  Py_TPFLAGS_DEFAULT|Py_TPFLAGS_HAVE_VERSION_TAG|Py_TPFLAGS_CHECKTYPES|Py_TPFLAGS_HAVE_NEWBUFFER|Py_TPFLAGS_BASETYPE,
  __pyx_type_10fast_tiles_TileGrid_slots,
};
#else

static PyTypeObject __pyx_type_10fast_tiles_TileGrid = {
  PyVarObject_HEAD_INIT(0, 0)
  "fast_tiles.""TileGrid", /*tp_name*/
  sizeof(struct __pyx_obj_10fast_tiles_TileGrid), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_10fast_tiles_TileGrid, /*tp_dealloc*/
  ...
  PyDoc_STR("Flat C arrays mirroring the Python tile dict for fast spatial queries."), /*tp_doc*/
  0, /*tp_traverse*/
  0, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_10fast_tiles_TileGrid, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_10fast_tiles_TileGrid, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static int __Pyx_modinit_type_init_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Type init code ---*/
  __pyx_vtabptr_10fast_tiles_TileGrid = &__pyx_vtable_10fast_tiles_TileGrid;
  __pyx_vtable_10fast_tiles_TileGrid._idx = (int (*)(struct __pyx_obj_10fast_tiles_TileGrid *, int, int))__pyx_f_10fast_tiles_8TileGrid__idx;
  __pyx_vtable_10fast_tiles_TileGrid._in_bounds = (int (*)(struct __pyx_obj_10fast_tiles_TileGrid *, int, int))__pyx_f_10fast_tiles_8TileGrid__in_bounds;
  __pyx_vtable_10fast_tiles_TileGrid._is_walkable = (int (*)(struct __pyx_obj_10fast_tiles_TileGrid *, int, int))__pyx_f_10fast_tiles_8TileGrid__is_walkable;
  __pyx_vtable_10fast_tiles_TileGrid._check_exit = (int (*)(struct __pyx_obj_10fast_tiles_TileGrid *, int, int, int))__pyx_f_10fast_tiles_8TileGrid__check_exit;
  #if CYTHON_USE_TYPE_SPECS
  __pyx_mstate->__pyx_ptype_10fast_tiles_TileGrid = (PyTypeObject *) __Pyx_PyType_FromModuleAndSpec(__pyx_m, &__pyx_type_10fast_tiles_TileGrid_spec, NULL); if (unlikely(!__pyx_mstate->__pyx_ptype_10fast_tiles_TileGrid)) __PYX_ERR(0, 29, __pyx_L1_error)
  if (__Pyx_fix_up_extension_type_from_spec(&__pyx_type_10fast_tiles_TileGrid_spec, __pyx_mstate->__pyx_ptype_10fast_tiles_TileGrid) < (0)) __PYX_ERR(0, 29, __pyx_L1_error)
  #else
  __pyx_mstate->__pyx_ptype_10fast_tiles_TileGrid = &__pyx_type_10fast_tiles_TileGrid;
  #endif
  #if !CYTHON_COMPILING_IN_LIMITED_API
  #endif
  #if !CYTHON_USE_TYPE_SPECS
  if (__Pyx_PyType_Ready(__pyx_mstate->__pyx_ptype_10fast_tiles_TileGrid) < (0)) __PYX_ERR(0, 29, __pyx_L1_error)
  #endif
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount((PyObject*)__pyx_mstate->__pyx_ptype_10fast_tiles_TileGrid);
  #endif
  #if !CYTHON_COMPILING_IN_LIMITED_API
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_mstate->__pyx_ptype_10fast_tiles_TileGrid->tp_dictoffset && __pyx_mstate->__pyx_ptype_10fast_tiles_TileGrid->tp_getattro == PyObject_GenericGetAttr)) {
    __pyx_mstate->__pyx_ptype_10fast_tiles_TileGrid->tp_getattro = PyObject_GenericGetAttr;
  }
  #endif
  if (__Pyx_SetVtable(__pyx_mstate->__pyx_ptype_10fast_tiles_TileGrid, __pyx_vtabptr_10fast_tiles_TileGrid) < (0)) __PYX_ERR(0, 29, __pyx_L1_error)
  if (__Pyx_MergeVtables(__pyx_mstate->__pyx_ptype_10fast_tiles_TileGrid) < (0)) __PYX_ERR(0, 29, __pyx_L1_error)
  if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_TileGrid, (PyObject *) __pyx_mstate->__pyx_ptype_10fast_tiles_TileGrid) < (0)) __PYX_ERR(0, 29, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject *) __pyx_mstate->__pyx_ptype_10fast_tiles_TileGrid) < (0)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __pyx_pymod_exec_fast_tiles(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_fast_tiles},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "fast_tiles",
      __pyx_k_Flat_C_arrays_for_tile_walkabil, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_fast_tiles(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_fast_tiles(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_fast_tiles(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'fast_tiles' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "fast_tiles" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_fast_tiles", 0);
  ...
  if (__pyx_module_is_main_fast_tiles) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fast_tiles")) {
      if (unlikely((PyDict_SetItemString(modules, "fast_tiles", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *         cdef int w = game_map.x_max - game_map.x_min + 1
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_10fast_tiles_8TileGrid_5sync, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global->__pyx_n_u_TileGrid_sync, NULL, __pyx_mstate_global->__pyx_n_u_fast_tiles, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (__Pyx_SetItemOnTypeDict(__pyx_mstate_global->__pyx_ptype_10fast_tiles_TileGrid, __pyx_mstate_global->__pyx_n_u_sync, __pyx_t_2) < (0)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * 
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_10fast_tiles_8TileGrid_7is_walkable, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global->__pyx_n_u_TileGrid_is_walkable, NULL, __pyx_mstate_global->__pyx_n_u_fast_tiles, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (__Pyx_SetItemOnTypeDict(__pyx_mstate_global->__pyx_ptype_10fast_tiles_TileGrid, __pyx_mstate_global->__pyx_n_u_is_walkable, __pyx_t_2) < (0)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *         if not self._is_walkable(to_x, to_y):
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_10fast_tiles_8TileGrid_9is_passable, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global->__pyx_n_u_TileGrid_is_passable, NULL, __pyx_mstate_global->__pyx_n_u_fast_tiles, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[2])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 127, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (__Pyx_SetItemOnTypeDict(__pyx_mstate_global->__pyx_ptype_10fast_tiles_TileGrid, __pyx_mstate_global->__pyx_n_u_is_passable, __pyx_t_2) < (0)) __PYX_ERR(0, 127, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * 
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_10fast_tiles_8TileGrid_11spatial_walls, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global->__pyx_n_u_TileGrid_spatial_walls, NULL, __pyx_mstate_global->__pyx_n_u_fast_tiles, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[3])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 160, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init fast_tiles", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init fast_tiles");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {2, 0, 0, 13, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 51};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_self, __pyx_mstate->__pyx_n_u_game_map, __pyx_mstate->__pyx_n_u_w, __pyx_mstate->__pyx_n_u_h, __pyx_mstate->__pyx_n_u_n, __pyx_mstate->__pyx_n_u_i, __pyx_mstate->__pyx_n_u_packed, __pyx_mstate->__pyx_n_u_key, __pyx_mstate->__pyx_n_u_tile, __pyx_mstate->__pyx_n_u_tx, __pyx_mstate->__pyx_n_u_ty, __pyx_mstate->__pyx_n_u_idx, __pyx_mstate->__pyx_n_u_b};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_fast_tiles_pyx, __pyx_mstate->__pyx_n_u_sync, __pyx_mstate->__pyx_kp_b_iso88591_A_XWBhgRq_XWBhgRq_IXQ_IXQ_IQ_Ja, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {3, 0, 0, 3, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 124};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_self, __pyx_mstate->__pyx_n_u_x, __pyx_mstate->__pyx_n_u_y};
    __pyx_mstate_global->__pyx_codeobj_tab[1] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_fast_tiles_pyx, __pyx_mstate->__pyx_n_u_is_walkable, __pyx_mstate->__pyx_kp_b_iso88591_A_t1D_Qc, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[1])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {5, 0, 0, 9, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 127};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_self, __pyx_mstate->__pyx_n_u_from_x, __pyx_mstate->__pyx_n_u_from_y, __pyx_mstate->__pyx_n_u_to_x, __pyx_mstate->__pyx_n_u_to_y, __pyx_mstate->__pyx_n_u_dx, __pyx_mstate->__pyx_n_u_dy, __pyx_mstate->__pyx_n_u_exit_bit, __pyx_mstate->__pyx_n_u_entry_bit};
    __pyx_mstate_global->__pyx_codeobj_tab[2] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_fast_tiles_pyx, __pyx_mstate->__pyx_n_u_is_passable, __pyx_mstate->__pyx_kp_b_iso88591_A_4t_q_1_e2Q_e2Q_3c_4s_Q_uL_Bd_S, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[2])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {4, 0, 0, 23, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 160};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_self, __pyx_mstate->__pyx_n_u_cx, __pyx_mstate->__pyx_n_u_cy, __pyx_mstate->__pyx_n_u_sight, __pyx_mstate->__pyx_n_u_sight_f, __pyx_mstate->__pyx_n_u_dirs, __pyx_mstate->__pyx_n_u_result, __pyx_mstate->__pyx_n_u_dx, __pyx_mstate->__pyx_n_u_dy, __pyx_mstate->__pyx_n_u_step, __pyx_mstate->__pyx_n_u_d, __pyx_mstate->__pyx_n_u_px, __pyx_mstate->__pyx_n_u_py, __pyx_mstate->__pyx_n_u_ppx, __pyx_mstate->__pyx_n_u_ppy, __pyx_mstate->__pyx_n_u_i, __pyx_mstate->__pyx_n_u_passable, __pyx_mstate->__pyx_n_u_ring, __pyx_mstate->__pyx_n_u_ring_tiles, __pyx_mstate->__pyx_n_u_ring_walk, __pyx_mstate->__pyx_n_u_ddx, __pyx_mstate->__pyx_n_u_ddy, __pyx_mstate->__pyx_n_u_adj_walk};
